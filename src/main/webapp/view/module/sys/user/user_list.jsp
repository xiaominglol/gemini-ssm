    ...
    <div class="row">
        <div class="col-md-4">
            <div id="toolbar" class="btn-group btn-group-md">
                <%--<shiro:hasPermission name="333333">--%>
            ...
            <div class="modal-body">
                <form id="form" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="userAccount" name="userAccount" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="empId" name="empId" placeholder=""
                                   value="E0001">
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function initTable() {
        $('#table').bootstrapTable({
            url: '${ctx}/UserController/pageList',		//（必须）请求地址
            method: 'get', 							//请求方式
